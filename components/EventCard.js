  ...
  return (
    ...
    <ul className="flex flex-col items-center justify-center w-full h-full gap-4 p-4">
      {presentations.map((presentation, index) => (
        <li key={index} className="flex items-center w-full gap-8">
          <div className="text-3xl min-w-[60px] w-[60px] font-bold text-theme-green leading-7">{presentation.hour}</div>
          <div>
